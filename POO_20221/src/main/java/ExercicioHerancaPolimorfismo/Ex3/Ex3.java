...
//        semanaComputacao.printaPalestras();
        ...
        for(Palestra pal : semanaComputacao.getPalestras()){
            Aluno matheus = new Aluno(1234, "Matheus", "matheus@gmail", "Computacao");
            Professor rafael = new Professor(4321, "Rafael", "rafael@gmail", "IC");
            Funcionario artur = new Funcionario(2314, "Artur", "artur@gmail", "Diretor");
...
//        semanaComputacao.printaPalestras();
        ...
        Aluno gabriel = new Aluno(3241, "Gabriel", "gabriel@gmail", "Sistemas de Informacao");
